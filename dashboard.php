  ...
  <html lang="en">
    ...
    <body>
        ...
        <p>
            ...
            $skills=$_POST['skills'];
            $CTC=$_POST['CTC'];
            $sql = "INSERT INTO `dashboard`(`Hospital Name`,`Nurse Position`,`Nurse Description`,`Skills`,`Availability`) VALUES('$cname','$position','$description','$skills','$CTC')" ;
      ...
      <thead>
        ...
        <?php 
          $sql="SELECT `Hospital Name`, `Nurse Position`, `Availability` FROM `dashboard`;";
