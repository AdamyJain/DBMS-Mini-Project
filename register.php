<?php include 'config.php' ?>
  ...
  <html lang="en">
    ...
    <body style="background:#f7f4eb">
    <form method="POST" style="background-color: #fff;margin-top: 3em;margin-right: 20em;margin-left: 20em;padding: 20px;box-shadow: 10px 10px 8px 10px #888888;border-radius: 12px;border:0;">
      <div class="details mb-3">   
      <h2 style="font-weight:bold; padding-left:300px;font-size:50px;">REGISTER</h2><br>
      <div class="mb-3">
